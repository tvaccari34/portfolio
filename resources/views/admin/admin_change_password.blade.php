                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.password') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="new_password" class="form-control" type="password" placeholder="New Password" id="new_password">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="confirm_password" class="form-control" type="password" placeholder="Confirm Password" id="confirm_password">
                                </div>
                            </div>
